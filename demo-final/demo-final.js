...
import { vertexSource, fragmentSource } from '../shaders/demo-final.glsl.js'
...
gl.uniform1f(slider0Loc, input0.value)
gl.uniform1f(slider1Loc, input1.value)
gl.uniform1f(slider2Loc, input2.value)
gl.uniform1i(checkboxLoc, checkbox.checked)
